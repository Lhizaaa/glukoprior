...
const CRIT = [
  {code:'C1', name:'HbA1c', desc:'Kadar gula darah 3 bulan', unit:'%',       w:0.30, type:'benefit'},
  {code:'C2', name:'Gula Darah Puasa', desc:'GDP', unit:'mg/dL',             w:0.20, type:'benefit'},
  {code:'C3', name:'Tekanan Darah Sistolik', desc:'Komorbid hipertensi', unit:'mmHg', w:0.15, type:'benefit'},
  {code:'C4', name:'Jumlah Komplikasi', desc:'Retinopati, nefropati, dll', unit:'kondisi', w:0.25, type:'benefit'},
  {code:'C5', name:'Tingkat Kepatuhan', desc:'1=buruk … 5=sangat patuh', unit:'skala', w:0.10, type:'cost'},
];
const PALETTE=['#D64545','#E08A2B','#3E9D6E','#2E6BB0','#7A52B0','#0E7C6B','#C9A227','#B0527A','#527AB0','#5BA199'];
let patients = JSON.parse(JSON.stringify(DEFAULT_PATIENTS));
